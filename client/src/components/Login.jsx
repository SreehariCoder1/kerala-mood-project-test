...
function Login({ onSwitchToRegister }) {
    ...
    // The AuthContext's login function is no longer directly used by this component
    // as we are redirecting to an external OAuth flow.
    // const { login } = useContext(AuthContext);

    // handleSubmit is removed as there's no manual form submission.
            ...
            <div className="max-w-md w-full bg-slate-800/50 backdrop-blur-lg rounded-2xl p-8 shadow-2xl border border-slate-700">
                ...
                <div className="mb-6">
                    <button
                        ...
                        className="w-full flex items-center justify-center space-x-2 bg-white text-slate-900 py-3 rounded-lg font-semibold hover:bg-slate-100 transition-colors shadow-md"
                    >
